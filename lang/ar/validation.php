...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية رقمية ورموز بايت واحد فقط.',
    ...
    'digits' => 'يجب أن يكون طول حقل :attribute :digits أرقام.',
    'digits_between' => 'يجب أن يكون طول حقل :attribute بين :min و :max أرقام.',
    'dimensions' => 'الصورة الموجودة في حقل :attribute أبعاد غير صالحة.',
    ...
    'extensions' => 'يجب أن يحتوي حقل :attribute على ملف من النوع: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'يظهر :attribute المعطى في تسرب بيانات. يرجى اختيار :attribute مختلفًا.',
    ],
    ...
    | تقنية "attribute.rule" لتسمية الأسطر. هذا يجعل من السهل
    | تحديد رسالة لغوية مخصصة معينة لقاعدة السمة المعطاة.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | تستخدم السطور اللغوية التالية لتبديل بديلنا المؤقت للسمات مثل
    | "عنوان البريد الإلكتروني" بدلاً من "email". هذا ببساطة يساعدنا على جعل رسالتنا أكثر تعبيرًا.
    |
    */
